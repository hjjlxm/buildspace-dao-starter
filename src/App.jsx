...
const App = () => {
  ...
  const { contract: token } = useContract('0xC672c5E5EB904A4046c87E354bDfD2D5118B1624', 'token');
  const { contract: vote } = useContract("0x05361fbcaE57C1F61b3e3E3c569e17A3dc687F69", "vote");
